...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resizeImage.js":[function(require,module,exports) {
"use strict";
...
/*eslint-disable*/
var resizeImage = exports.resizeImage = function resizeImage(image, targetWidth, targetHeight) {
  var targetElement = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
  return new Promise(function (resolve, reject) {
    var filerdr = new FileReader();
    filerdr.onload = function (evt) {
      var img = new Image();
      img.onload = function () {
        ...
        resolve(data); // Trả về dữ liệu khi tất cả đã xử lý xong
      };
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51ONydXJHbgv9zkHZ7WpDV392WjxdpmnCxHegIPACsiT9IvbdI8kL2b8Njlz1qNgBtRa1dPBjQmj0GCGDwYpe4RmG00TThHkofv'); // 1) Get checkout session from API
          _context.prev = 1;
          _context.next = 4;
...
var _resizeImage = require("./resizeImage.js");
...
var userPasswordForm = document.getElementsByTagName('form')[1];
...
var handleDisplayUserPhoto = function handleDisplayUserPhoto(e) {
  var _e$target$files;
  var imgFile = (_e$target$files = e.target.files) === null || _e$target$files === void 0 ? void 0 : _e$target$files[0];
